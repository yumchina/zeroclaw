...
- **Channel approval cancellation**: `Channel::cancel_approval(approval_id, recipient, reason)` default no-op method added to the trait; the DawnIM channel implements it to clear pending cards when a fan-out loser cancels early.
